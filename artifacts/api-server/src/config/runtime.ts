...
export const runtimeConfig = {
  ...
  analytics: {
    ...
    adminEnabled: env.ANALYTICS_ADMIN_ENABLED,
    debugLogs: env.ANALYTICS_DEBUG_LOGS,
    heartbeatIntervalSeconds: env.ANALYTICS_HEARTBEAT_INTERVAL_SECONDS,
    sessionStaleSeconds: env.ANALYTICS_SESSION_STALE_SECONDS,
    eventMaxMetadataBytes: env.ANALYTICS_EVENT_MAX_METADATA_BYTES,
    adminCacheTtlSeconds: env.ANALYTICS_ADMIN_CACHE_TTL_SECONDS,
