...
const envSchema = z
  .object({
    ...
    RATE_LIMIT_AUTH_SIGN_IN_IDENTIFIER_MAX: integerLikeSchema.default(10),
    RATE_LIMIT_AUTH_REFRESH_IP_MAX: integerLikeSchema.default(120),
    RATE_LIMIT_AUTH_REFRESH_IDENTIFIER_MAX: integerLikeSchema.default(30),
    RATE_LIMIT_AUTH_VERIFY_EMAIL_RESEND_IP_MAX: integerLikeSchema.default(20),
    RATE_LIMIT_AUTH_VERIFY_EMAIL_RESEND_IDENTIFIER_MAX: integerLikeSchema.default(5),
    RATE_LIMIT_AUTH_PASSWORD_RESET_REQUEST_IP_MAX: integerLikeSchema.default(20),
    RATE_LIMIT_AUTH_PASSWORD_RESET_REQUEST_IDENTIFIER_MAX: integerLikeSchema.default(5),
    RATE_LIMIT_AUTH_PASSWORD_RESET_CONFIRM_IP_MAX: integerLikeSchema.default(20),
    RATE_LIMIT_AUTH_PASSWORD_RESET_CONFIRM_IDENTIFIER_MAX: integerLikeSchema.default(5),
...
function normalizeEnv(env: NodeJS.ProcessEnv): Record<string, unknown> {
  ...
  return {
    ...
    RATE_LIMIT_AUTH_SIGN_IN_IP_MAX: env.RATE_LIMIT_AUTH_SIGN_IN_IP_MAX ?? "30",
    RATE_LIMIT_AUTH_SIGN_IN_IDENTIFIER_MAX:
      env.RATE_LIMIT_AUTH_SIGN_IN_IDENTIFIER_MAX ?? "10",
    RATE_LIMIT_AUTH_REFRESH_IP_MAX: env.RATE_LIMIT_AUTH_REFRESH_IP_MAX ?? "120",
    RATE_LIMIT_AUTH_REFRESH_IDENTIFIER_MAX:
      env.RATE_LIMIT_AUTH_REFRESH_IDENTIFIER_MAX ?? "30",
    RATE_LIMIT_AUTH_VERIFY_EMAIL_RESEND_IP_MAX:
      env.RATE_LIMIT_AUTH_VERIFY_EMAIL_RESEND_IP_MAX ?? "20",
    RATE_LIMIT_AUTH_VERIFY_EMAIL_RESEND_IDENTIFIER_MAX:
      env.RATE_LIMIT_AUTH_VERIFY_EMAIL_RESEND_IDENTIFIER_MAX ?? "5",
    RATE_LIMIT_AUTH_PASSWORD_RESET_REQUEST_IP_MAX:
      env.RATE_LIMIT_AUTH_PASSWORD_RESET_REQUEST_IP_MAX ?? "20",
    RATE_LIMIT_AUTH_PASSWORD_RESET_REQUEST_IDENTIFIER_MAX:
      env.RATE_LIMIT_AUTH_PASSWORD_RESET_REQUEST_IDENTIFIER_MAX ?? "5",
    RATE_LIMIT_AUTH_PASSWORD_RESET_CONFIRM_IP_MAX:
      env.RATE_LIMIT_AUTH_PASSWORD_RESET_CONFIRM_IP_MAX ?? "20",
    RATE_LIMIT_AUTH_PASSWORD_RESET_CONFIRM_IDENTIFIER_MAX:
      env.RATE_LIMIT_AUTH_PASSWORD_RESET_CONFIRM_IDENTIFIER_MAX ?? "5",
